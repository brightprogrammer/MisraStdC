...
// ===========================================================================
// Moved from Elf.Blind. Uses its own bl_-prefixed little-endian writers and
// header builder so it stays independent of the baseline fixture helpers.
// ===========================================================================
