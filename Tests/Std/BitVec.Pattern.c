...
int main(void) {
    printf("[INFO] Starting Bits.Pattern tests\n\n");

    // Array of test functions
    TestFunction tests[] = {
        test_Bits_basic_pattern_functions,
        test_Bits_find_pattern,
        test_Bits_find_last_pattern,
        test_Bits_find_all_pattern,
        test_Bits_pattern_edge_cases,
        test_Bits_pattern_stress_tests,
        // New Pattern function tests
        test_Bits_starts_with_basic,
        test_Bits_starts_with_edge_cases,
        test_Bits_ends_with_basic,
        test_Bits_ends_with_edge_cases,
        test_Bits_contains_basic,
        test_Bits_contains_at_basic,
        test_Bits_contains_at_edge_cases,
        test_Bits_count_pattern_basic,
        test_Bits_rfind_pattern_basic,
        test_Bits_replace_basic,
        test_Bits_replace_all_basic,
        test_Bits_matches_basic,
        test_Bits_fuzzy_match_basic,
        test_Bits_regex_match_basic,
        test_Bits_prefix_match_basic,
        test_Bits_suffix_match_basic
    };

    // Deadend tests that would cause program termination
    TestFunction deadend_tests[] = {
        test_Bits_find_pattern_null_source,
        test_Bits_find_pattern_null_pattern,
        test_Bits_find_last_pattern_null_source,
        test_Bits_find_last_pattern_null_pattern,
        test_Bits_find_all_pattern_null_source,
        test_Bits_find_all_pattern_null_pattern,
        test_Bits_find_all_pattern_null_results,
        test_Bits_find_all_pattern_zero_max_results,
        // New Pattern function deadend tests
        test_Bits_starts_with_null_source,
        test_Bits_starts_with_null_prefix,
        test_Bits_ends_with_null_source,
        test_Bits_ends_with_null_suffix,
        test_Bits_contains_at_null_source,
        test_Bits_contains_at_null_pattern,
        test_Bits_replace_null_source,
        test_Bits_matches_null_source,
        test_Bits_regex_match_null_source,
        test_Bits_regex_match_null_pattern,
        test_Bits_prefix_match_null_source,
        test_Bits_prefix_match_null_patterns,
        test_Bits_suffix_match_null_source,
        test_Bits_suffix_match_null_patterns
    };
