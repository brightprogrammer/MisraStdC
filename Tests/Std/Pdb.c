...
// ===========================================================================
// Mutation-hardening tests (batch 6, ex-Blind): crafted MSF/PDB blobs driven
// through the PUBLIC API with observable divergence read from resolved
// functions, open success/failure, or the DebugAllocator's overflow counter.
// ===========================================================================
