...
// -----------------------------------------------------------------------------
// Blind-survivor hardening (from MachoCache.Blind). Targets the four blind
// survivors on the DWARF fall-through path:
//
...
//
// Main + dSYM symtabs are empty and the function name lives only in the
// dSYM's __DWARF .debug_info. These fixtures are self-contained.
// -----------------------------------------------------------------------------
