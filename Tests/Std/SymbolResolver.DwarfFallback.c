...
bool test_dwarffallback_source_lines(void) {
    ...
    ok = ok && ra.source_file && ZstrFindSubstring(ra.source_file, "SymbolResolver.DwarfFallback.c") != NULL;
    ok = ok && rb.source_file && ZstrFindSubstring(rb.source_file, "SymbolResolver.DwarfFallback.c") != NULL;
