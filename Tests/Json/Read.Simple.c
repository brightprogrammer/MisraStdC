...
bool test_simple_person_object(void) {
    ...
    bool success = true;
    Str json = StrInitFromZstr("{\"id\": 1001, \"name\": \"Bob\", \"age\": 25, \"is_active\": true, \"salary\": 50000.0}");
    StrIter si = StrIterFromStr(json);
...
bool test_simple_nested_object(void) {
    ...
    bool success = true;
    Str json = StrInitFromZstr("{\"user\": {\"name\": \"Charlie\", \"email\": \"charlie@example.com\"}, \"active\": true}");
    StrIter si = StrIterFromStr(json);
...
bool test_simple_product_with_tags(void) {
    ...
    bool success = true;
    Str json = StrInitFromZstr("{\"id\": 12345, \"name\": \"Laptop\", \"price\": 999.99, \"tags\": [\"electronics\", \"computers\", \"portable\"]}");
    StrIter si = StrIterFromStr(json);
